    ...
    <div className="min-h-screen">
      <div className="relative h-[40vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1562141961-b5d1735f6418?auto=format&fit=crop&q=80")',
          }}
        />
        ...
        <div className="relative container text-center text-white">
          ...
          <p className="text-xl max-w-2xl mx-auto">
            Leading the way in luxury automotive excellence since 1970
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              Founded in 1970, Mide&Dara Motors has been at the forefront of the luxury automotive industry for over five decades. What started as a small dealership has grown into one of Nigeria's most trusted names in premium vehicles.
            </p>
